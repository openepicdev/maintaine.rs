...
- **[python-benedict](https://github.com/fabiocaccamo/python-benedict)** — A supercharged `dict` subclass that makes working with dictionaries easier and more powerful.
- **[django-admin-interface](https://github.com/fabiocaccamo/django-admin-interface)** — A modern, responsive and customizable UI on top of the default Django admin.
- **[FCUUID](https://github.com/fabiocaccamo/FCUUID)** — A reliable way to generate and persist UUIDs on iOS devices.
