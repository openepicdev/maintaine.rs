...
Hey, I am Pradumna Saraf, an Open Source Developer/DevRel based out in India. I am also a [Docker Captain](https://www.docker.com/captains/pradumna-saraf), a DevOps and Golang Developer. I am passionate about Open Source and have mentored hundreds of people to break into the ecosystem. People in the community know me for the content I create on X (formerly Twitter) and LinkedIn, educating others about Open Source and DevOps tools. I also enjoy engaging with people in person and delivering talks at conferences like KubeCon, OpenSFF, and more.

My journey with Open Source began in 2021 during Hacktoberfest with the EddieHub Community (founded by Eddie Jaoude, shout out to him, I see him as my godfather and a good friend). When I joined the community, I was amazed by how people were helping each other and making their work public for anyone to see. At first, it felt a bit weird, but over time, I came to understand its importance. That spirit of openness and collaboration stuck with me, and here I am today, sharing my Open Source journey with you all. It was a very random and unexpected journey, but I am glad I took it.
...
On the other hand, have some empathy for the new contributors because they might have less knowledge compared to a maintainer, so try to help them get started, encourage and uplift them, because a contributor is a maintainer in the making.
...
If you want to discuss anything related to Open Source, feel free to reach out to me on any of the following channels:
...
- Email: [pradumnasaraf@gmail.com](mailto:pradumnasaraf@gmail.com)
