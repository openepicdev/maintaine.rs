...
- **Dedicated participation in mentorships** ([GitHub](https://github.com/asyncapi/community/tree/master/mentorship)). We also set up our own mentorship program. We're pushing for a new concept we call [`Maintainership`](https://www.brainfart.dev/blog/maintainership), which focuses not on creating new projects but on mentoring people on how to become a maintainer and how complex and responsible a role it is.
