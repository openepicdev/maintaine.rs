...
One of the first steps in this journey is Git e GitHub para Humanos[^250] — our first public book, written entirely in Portuguese.
...
If you're curious to learn more about the projects we're building, feel free to explore [cumbuca.dev][cumbuca-site], our GitHub organization at [github.com/cumbucadev][cumbuca-org], and some of the initiatives close to our hearts like [ScanAPI][scanapi-site], [brutils-python][brutils-python], and Git e GitHub para Humanos[^251]. We’d love for you to join us on this journey — whether by contributing, learning, or simply sharing the passion for making Open Source more inclusive for everyone.
...
[^250]: https://github.com/cumbucadev/git-e-github-para-humanos
