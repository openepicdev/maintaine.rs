...
It all started during my time at Loadsmart[^287], a logistics company where I spent nearly four years. It was there that I met Gustavo Barbosa[^288] — and everything started to shift. He introduced me to Danger[^289], an open-source tool that automates tasks and highlights issues during code reviews, and a plugin he had created, danger-android_lint[^290], which integrates Android Lint checks directly into pull requests. From the moment I saw it, I was hooked.

At the time, around 2018, GitHub Actions[^291] wasn’t around yet. The idea of automating Pull Request reviews in such a simple, flexible way felt like magic. But what truly fascinated me was the global collaboration I saw happening. People from different corners of the world working together on the same codebase, even though they had never met — that blew my mind. It was this sense of community that drew me in and made me realize the power of Open Source.

One day, we spent hours trying to fix a bug in Danger and just couldn’t crack it. While I was visiting Loadsmart’s New York office, we decided to check out a CocoaPods Peer Lab Meetup[^292] at Artsy[^293] — hoping we could get help. There, we paired with Orta Therox[^294], the creator of Danger, and together we finally solved it. Sitting with him, learning, chatting, eating pizza — it was surreal. That experience showed me firsthand how Open Source can lead to genuine connection, shared knowledge, and opportunities that might never happen in more traditional tech spaces.

As I immersed myself more and more in the Open Source world, I started hearing stories that inspired me deeply. I learned about Felix Krause[^295] and his tool Fastlane[^296], Max Stoiber[^297] and his project react-boilerplate[^298], and many others who had built incredible things. Each story added fuel to the fire — I knew I wanted to be part of this movement.
...
I received an email from someone named Daniel Compton[^300] at GitHub. It wasn’t spam — it was real. New Relic[^301], a major tech company, wanted to sponsor my GitHub profile. I was stunned. It was the first time someone wanted to _financially_ support what I was building. It felt surreal.

There was just one problem: GitHub Sponsors[^302] wasn’t available in Brazil yet. After a few back-and-forth emails, Daniel told me:
...
Later that year, in December, ScanAPI received a one-time donation of $1,000 USD through GitHub Sponsors. It came from Red Hat[^303]. No email. No announcement. Just support. Back in October 2020, I had given a talk about ScanAPI to their internal engineering team, invited by Og Maciel[^304]. I had no idea it had made that kind of impact. But apparently, it had.
...
Before we continue, let’s take a quick break from the main timeline and rewind a bit — back to July 2021. My cousin — Maria[^308] — asked if we could schedule a one-on-one — she had a bunch of questions about tech. After trying many different paths in life, she was now considering a career change to something more stable, and I.T. was on her radar.
...
Step by step, she learned how the library worked — how to contribute to it, how to maintain it, how to think collaboratively and build for the long term. By October of that same year, during Hacktoberfest[^310], she was already coordinating a group of over ten people contributing simultaneously.
...
In August 2023, after everything we had learned from Maria’s journey, we decided to take things a step further — and that’s when Cumbuca Dev[^311] was born.
...
In December 2023, I joined Trade Republic[^312]. But it didn’t take long for me to realize: my path was no longer about working for a company. Cumbuca was taking shape. New projects were blooming. And my time simply wasn’t enough anymore.
...
If you're curious to learn more about the projects we're building, feel free to explore [cumbuca.dev](https://cumbuca.dev), our GitHub organization at [github.com/cumbucadev](https://github.com/cumbucadev), and some of the initiatives close to our hearts like ScanAPI[^313], brutils-python[^314], and Git e GitHub para Humanos[^284]. We’d love for you to join us on this journey — whether by contributing, learning, or simply sharing the passion for making Open Source more inclusive for everyone.
...
[^285]: https://en.wikipedia.org/wiki/Catch-22_(logic)
[^286]: https://github.com/camilamaia
[^287]: https://loadsmart.com/
[^288]: https://github.com/barbosa
[^289]: https://danger.systems/
[^290]: https://github.com/loadsmart/danger-android_lint
[^291]: https://github.com/features/actions
[^292]: https://artsy.github.io/blog/2015/08/10/peer-lab/
[^293]: https://github.com/artsy
[^294]: https://github.com/orta
[^295]: https://github.com/KrauseFx
[^296]: https://github.com/fastlane/fastlane
[^297]: https://github.com/mxstbr
[^298]: https://github.com/react-boilerplate/react-boilerplate
[^299]: https://github.com/scanapi/scanapi
[^300]: https://github.com/danielcompton
[^301]: https://newrelic.com/
[^302]: https://github.com/sponsors
[^303]: https://www.redhat.com/
[^304]: https://github.com/omaciel
[^305]: https://soundcloud.com/
[^306]: https://prometheus.io/
[^307]: https://developers.soundcloud.com/blog/stop-hacker-time
[^308]: https://github.com/antoniamaia
[^309]: https://github.com/brazilian-utils/brutils-python
[^310]: https://hacktoberfest.com/
[^311]: https://cumbuca.dev
[^312]: https://traderepublic.com/
[^313]: https://scanapi.dev
[^314]: https://github.com/brazilian-utils/brutils-python
