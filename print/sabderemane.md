...
I’m Sarah Abderemane[^350], a software engineer at Kraken based in France.

I’ve been a contributor to some projects related to the Python language and Django framework[^351] and I’m a maintainer of the Django website[^352] for a few years.

You can find out more about me on my website[^353] and follow me on social media.

## How I started to contribute

My journey began a few years ago with Hacktoberfest[^354], the most popular project to start contributing to Open Source.
...
Then, I contributed to bigger issues and bigger projects with the creation of the read the docs of Jupyter accessibility[^355] repository and I finally contributed to Django website to implement dark mode on the website and I became a maintainer after this.
...
One way we grow the community is via a mentorship program, Djangonaut Space[^356], that helps folks to contribute to Django core and its ecosystem with a mentor and a supporter to help through the Open Source journey with things like impostor syndrome.
...
[^350]: https://github.com/sabderemane
[^351]: https://github.com/django/django
[^352]: https://github.com/django/djangoproject.com
[^353]: http://sarahabd.com/
[^354]: https://hacktoberfest.com/
[^355]: https://jupyter-accessibility.readthedocs.io/en/latest/
[^356]: https://djangonaut.space/
