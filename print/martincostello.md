...
It all started with this pull request: Glimpse/Glimpse#493[^315].
...
- Polly[^314] - a .NET resilience and transient fault handling library
- [Swashbuckle.AspNetCore](https://github.com/domaindrivendev/Swashbuckle.AspNetCore) - OpenAPI tools for documenting APIs
  built with ASP.NET Core.
- HttpClient Interception[^313] - a library for intercepting and mocking HTTP requests for .NET applications
- xunit Logging[^312] - An logging library for xUnit.net to route application logs to the test output
...
1. Sponsor a project. An increasing number of Open Source projects now accept donations via GitHub Sponsors[^311], and
...
[^311]: https://github.com/sponsors
[^312]: https://github.com/martincostello/xunit-logging
[^313]: https://github.com/justeattakeaway/httpclient-interception
[^314]: https://github.com/App-vNext/Polly
[^315]: https://github.com/Glimpse/Glimpse/pull/493
