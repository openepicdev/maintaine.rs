...
It all started with this pull request: Glimpse/Glimpse#493[^312].
...
- Polly[^311] - a .NET resilience and transient fault handling library
- [Swashbuckle.AspNetCore](https://github.com/domaindrivendev/Swashbuckle.AspNetCore) - OpenAPI tools for documenting APIs
  built with ASP.NET Core.
- HttpClient Interception[^310] - a library for intercepting and mocking HTTP requests for .NET applications
- xunit Logging[^309] - An logging library for xUnit.net to route application logs to the test output
...
1. Sponsor a project. An increasing number of Open Source projects now accept donations via GitHub Sponsors[^308], and
...
[^308]: https://github.com/sponsors
[^309]: https://github.com/martincostello/xunit-logging
[^310]: https://github.com/justeattakeaway/httpclient-interception
[^311]: https://github.com/App-vNext/Polly
[^312]: https://github.com/Glimpse/Glimpse/pull/493
