...
_Hackers_[^323] by Steven Levy
and _Free as in Freedom_[^324] about Richard Stallman
...
My first contact with Open content was in 2006 when I joined OpenClipart[^325].
...
Terminal[^326], which I'm still maintaining. Back then, jQuery was the most
...
Aiki was an Open Source project led by Bassel Kartabil[^327]
that was later killed by the Syrian Regime during the civil war[^328].

During all those years, I created a few Open Source projects that were somewhat successful, like
Wayne[^329], Sysend[^330],
Tagger[^331], LIPS Scheme[^332],
Gaiman[^333], and
chat-gpt Bookmarklet[^334].

But my biggest project that I'm a maintainer of is
isomorphic-git[^335]. It's a pure JavaScript implementation of a git
...
Terminal[^336], where I used both isomorphic-git and jQuery Terminal. When
...
- How to Promote Your Open Source Project with SEO[^337]
...
If you're interested in what I do, you can find me on Twitter/X at \@jcubic[^338].

\newpage


[^323]: https://en.wikipedia.org/wiki/Hackers:_Heroes_of_the_Computer_Revolution
[^324]: https://en.wikipedia.org/wiki/Free_as_in_Freedom
[^325]: https://openclipart.org/
[^326]: https://terminal.jcubic.pl/
[^327]: https://en.wikipedia.org/wiki/Bassel_Khartabil
[^328]: https://en.wikipedia.org/wiki/Syrian_civil_war
[^329]: https://github.com/jcubic/wayne
[^330]: https://github.com/jcubic/sysend
[^331]: https://github.com/jcubic/tagger
[^332]: https://lips.js.org/
[^333]: https://github.com/jcubic/gaiman
[^334]: https://github.com/jcubic/chat-gpt
[^335]: https://isomorphic-git.org/
[^336]: https://git-terminal.js.org/
[^337]: https://itnext.io/seo-for-open-source-projects-1a6b17ffeb8b
[^338]: https://x.com/jcubic
