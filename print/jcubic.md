...
_Hackers_[^358] by Steven Levy
and _Free as in Freedom_[^359] about Richard Stallman
...
My first contact with Open content was in 2006 when I joined OpenClipart[^360].
...
Terminal[^361], which I'm still maintaining. Back then, jQuery was the most
...
Aiki was an Open Source project led by Bassel Kartabil[^362]
that was later killed by the Syrian Regime during the civil war[^363].

During all those years, I created a few Open Source projects that were somewhat successful, like
Wayne[^364], Sysend[^365],
Tagger[^366], LIPS Scheme[^367],
Gaiman[^368], and
chat-gpt Bookmarklet[^369].

But my biggest project that I'm a maintainer of is
isomorphic-git[^370]. It's a pure JavaScript implementation of a git
...
Terminal[^371], where I used both isomorphic-git and jQuery Terminal. When
...
- How to Promote Your Open Source Project with SEO[^372]
...
If you're interested in what I do, you can find me on Twitter/X at \@jcubic[^373].

\newpage


[^358]: https://en.wikipedia.org/wiki/Hackers:_Heroes_of_the_Computer_Revolution
[^359]: https://en.wikipedia.org/wiki/Free_as_in_Freedom
[^360]: https://openclipart.org/
[^361]: https://terminal.jcubic.pl/
[^362]: https://en.wikipedia.org/wiki/Bassel_Khartabil
[^363]: https://en.wikipedia.org/wiki/Syrian_civil_war
[^364]: https://github.com/jcubic/wayne
[^365]: https://github.com/jcubic/sysend
[^366]: https://github.com/jcubic/tagger
[^367]: https://lips.js.org/
[^368]: https://github.com/jcubic/gaiman
[^369]: https://github.com/jcubic/chat-gpt
[^370]: https://isomorphic-git.org/
[^371]: https://git-terminal.js.org/
[^372]: https://itnext.io/seo-for-open-source-projects-1a6b17ffeb8b
[^373]: https://x.com/jcubic
