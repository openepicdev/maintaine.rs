...
However, I quickly learned that spending every weeknight and weekend toiling away at open GitHub issues is a quick path to burnout. I wrote an article[^65] on the topic that struck a nerve with the Open Source community, and eventually coincided with my stepping away from the project in 2017\.
...
**Leaving a project is not the end of the world.** As my friend Jan Lehnardt has said, “The tech comes and goes, but the people remain.”[^64] You can step away from a project without sacrificing the community or reputation you’ve built up in the interim. And in the end, your software still _works_ and delivers value for people, even without you actively working on it. And by leaving, you may even open up space for newer contributors to fill your shoes.
...
[^58]: https://semver.org/
[^59]: https://en.wikipedia.org/wiki/Npm_left-pad_incident
[^60]: https://cve.mitre.org/
[^61]: https://en.wikipedia.org/wiki/Supply_chain_security
[^62]: https://en.wikipedia.org/wiki/Pareto_principle
[^63]: https://www.laws-of-software.com/laws/zawinski/
[^64]: https://narrativ.es/@janl/113339884688525095
[^65]: https://nolanlawson.com/2017/03/05/what-it-feels-like-to-be-an-open-source-maintainer/
