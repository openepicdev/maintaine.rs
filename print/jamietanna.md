...
My name's Jamie Tanna[^237] and I've been contributing to Open Source for >11 years, which extends to before my professional career began.

As with many others, my first foray into Open Source was a few spelling and grammar fixes[^245], but I remember being part of a computer security forum several years prior, where we would share code.
...
At the end of the day, we all benefit from continuing to work on the commons, companies most of all[^230]!

## Collector of Open Source projects

I have quite a number of projects I've built (with differing levels of support) that I have a page on my website[^244] listing all the projects!

The main ones that folks may know are `oapi-codegen`[^243], the OpenAPI-to-Go code generator, and dependency-management-data[^242], a tool for better understanding your dependency tree.

I've also previously been the primary maintainer for the Jenkins job-dsl-plugin[^241], and on the maintainer team for Wiremock[^240], and I've had contributor access to several projects over the last decade, and I'm also a fairly regular contributor to a number of other projects like Renovate[^239].
...
The Open Source project I've been most consistently contributing[^238] to is my personal website and blog[^237], which is also an Open Source project in of itself. It's shared freely to the world, with mostly `Apache-2.0` code snippets, and I truly do see this as another project I continue to invest in, whether writing blog posts as a form of blogumentation[^236], or sharing some lukewarm takes about Git commits[^235].
...
As noted in a post from last May[^227], we indicated that we'd like to try and move to a more sustainable model, taking in sponsorship to try and make the work on the project more consistent.

I'm incredibly fortunate to say that I have several sponsors[^234] who are great, and each paying for 1hr/month for me to work on the project, and my employer, Elastic[^233] gives me 4hr/month to work on the project.
...
In a post to `oapi-codegen` last year[^227], we made it clear that we appreciate there's a gap in the maintenance we've been doing, and do want to improve it, but can't feasibly without more financial support.
...
And a final one is to talk to your company about sponsoring Open Source[^226], and see if you can start helping the people doing the very hard work you rely upon.
...
[^226]: https://humanwhocodes.com/blog/2021/05/talk-to-your-company-sponsoring-open-source/
[^227]: https://github.com/oapi-codegen/oapi-codegen/discussions/1606
[^228]: https://github.com/thehale/PSAs
[^229]: https://mikemcquaid.com/open-source-maintainers-owe-you-nothing/
[^230]: https://www.jvt.me/posts/2022/10/22/tech-industry-free-labour/
[^231]: https://www.openapis.org/
[^232]: https://www.jvt.me/support-me/
[^233]: https://elastic.co
[^234]: https://github.com/oapi-codegen/oapi-codegen#sponsors
[^235]: https://www.jvt.me/posts/2024/07/12/things-know-commits/
[^236]: https://www.jvt.me/posts/2017/06/25/blogumentation/
[^237]: https://www.jvt.me
[^238]: https://www.jvt.me/archives/
[^239]: https://docs.renovatebot.com/
[^240]: https://github.com/wiremock/wiremock
[^241]: https://github.com/jenkinsci/job-dsl-plugin/
[^242]: https://dmd.tanna.dev
[^243]: https://github.com/oapi-codegen/oapi-codegen
[^244]: https://www.jvt.me/open-source/
[^245]: https://github.com/SamyPesse/How-to-Make-a-Computer-Operating-System/pull/18
