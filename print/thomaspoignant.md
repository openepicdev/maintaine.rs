...
I started with a small library called scim-patch[^284], and now I spend most of my time around feature flags I am building GO Feature Flag[^283], a feature flag platform that works with all your favorite languages and is integrated easily in any company tech. You can start using feature flags super fast with GO Feature Flag.

And I am also part of the OpenFeature[^282] technical committee. OpenFeature provides an open specification that provides a vendor-agnostic, community-driven API for feature flagging that works with any management tool or in-house solution.
...
[^282]: https://openfeature.dev
[^283]: https://github.com/thomaspoignant/go-feature-flag
[^284]: https://www.npmjs.com/package/scim-patch
