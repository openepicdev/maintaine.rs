...
- **python-benedict[^290]** — A supercharged `dict` subclass that makes working with dictionaries easier and more powerful.
- **django-admin-interface[^291]** — A modern, responsive and customizable UI on top of the default Django admin.
- **FCUUID[^292]** — A reliable way to generate and persist UUIDs on iOS devices.
...
[^290]: https://github.com/fabiocaccamo/python-benedict
[^291]: https://github.com/fabiocaccamo/django-admin-interface
[^292]: https://github.com/fabiocaccamo/FCUUID
