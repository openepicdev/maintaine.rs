...
So, I found my own path, helping by securing funding for one of the projects and promoting tools at conferences[^418].

Everyone needs a role model—someone to inspire or spark that first sense of purpose. For me, that person was Benjamin Lupton[^419]. We were using DocPad[^420], and after watching Ben's DocPad presentation[^421], I knew I was slowly becoming an open-source enthusiast, or maybe even a fanatic.
...
I’m active in the AsyncAPI Initiative[^422], and my highest priority is the AsyncAPI spec[^423] and the AsyncAPI Generator[^424]. At the moment, I’m the Executive Director of the initiative, but I’m stepping down in favour of our new Governance Board[^425].
...
- **Dedicated participation in mentorships** (GitHub[^426]). We also set up our own mentorship program. We're pushing for a new concept we call `Maintainership`, which focuses not on creating new projects but on mentoring people on how to become a maintainer and how complex and responsible a role it is.
- **AsyncAPI Conference** ([conference.asyncapi.com](https://conference.asyncapi.com/)) – rather than a single annual event that requires extensive travel, we hold multiple events and host smaller sessions at well-established conferences. This approach allows us to reach a larger, more diverse audience in different locations. I recommend you read in detail how from an online one-day event we scaled to most of the continents with multiple events a year[^427] so you can learn how such an approach can help you gain funding for the projects and friends that help to scale your community.
- Build a program that recognizes people who promote your project. Call it Ambassador, Champion, Hero, Jedi - whatever you like, just recognize these people and give them space. You will never be able to promote the project alone as much as in a group of various influencers. Our Ambassador program[^428] gathers people who talk about AsyncAPI at conferences, record videos, write articles - basically create publicly available content.
...
You can sponsor me[^429] of course or hire my services[^430] to fix that.
...
[^418]: https://www.youtube.com/watch?v=F-1goNbdBkc&t=1652s
[^419]: https://github.com/balupton
[^420]: https://docpad.bevry.me/
[^421]: https://www.youtube.com/watch?v=Zu1uhI0uT2o
[^422]: https://www.asyncapi.com/en
[^423]: https://github.com/asyncapi/spec
[^424]: https://github.com/asyncapi/generator
[^425]: https://www.asyncapi.com/blog/new-governance-board
[^426]: https://github.com/asyncapi/community/tree/master/mentorship
[^427]: https://www.brainfart.dev/blog/foss-grow-through-events
[^428]: https://www.asyncapi.com/community/ambassadors
[^429]: https://github.com/sponsors/derberg
[^430]: https://www.brainfart.dev/services
